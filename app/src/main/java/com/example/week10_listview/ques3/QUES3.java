...
public class QUES3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerAdapterForImages recyclerAdapterForImages = new RecyclerAdapterForImages(getApplicationContext(), superheroArrayList);

        recyclerView.setAdapter(recyclerAdapterForImages);
    }
}
